...
public class AdminWorkshopsController {
    ...
    public String createWorkshop(
        ...
        if (imageFiles != null && !imageFiles.isEmpty()) {
            ...
            if (!nonEmptyFiles.isEmpty()) {
                List<String> newImageUrls = storageService.storeMultiple(nonEmptyFiles, "workshop", savedWorkshop.getId());
    ...
    public String updateWorkshop(
        ...
        if (imageFiles != null && !imageFiles.isEmpty() && !imageFiles.get(0).isEmpty()) {
            try {
                List<String> newImageUrls = storageService.storeMultiple(imageFiles, "workshop", updatedWorkshop.getId());
                ...
                redirectAttributes.addFlashAttribute("error", "Se guardó el taller pero hubo un problema al subir las imágenes.");
                return "redirect:/admin/workshops";
            }
        }
